...
public class CurrencyConverter extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblTitle.setFont(new java.awt.Font("Italic", 1, 24));
        lblTitle.setForeground(Color.WHITE);
        lblTitle.setText("Currency Converter");

        cbSource.setFont(new java.awt.Font("Serif", 0, 18));
        ...
        lblFrom.setFont(new java.awt.Font("Serif", 1, 14));
        lblFrom.setText("Source currency");

        lblTo.setFont(new java.awt.Font("Serif", 1, 14));
        lblTo.setText("Target currency");

        txtSource.setFont(new java.awt.Font("Serif", 1, 14));

        txtTarget.setFont(new java.awt.Font("Serif", 1, 14));

        btnConvert.setFont(new java.awt.Font("Serif", 0, 18));
        ...
        pnlMain.setBackground(new Color(20, 0, 24));
